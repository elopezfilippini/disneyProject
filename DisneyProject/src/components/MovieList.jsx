...
const elementRef=useRef()
  ...
  return (
      ...
      <div className='relative'>
        ...
        {movieList.map((item,index)=>(<MovieCard movie={item} />       ))}</div>

  <HiChevronRight onClick={()=>sliderRight(elementRef.current)} className="hidden md:block text-white text-[30px] absolute right-0 mx-4 mt-[150px] top-0 z-10 cursor-pointer"/>
